...
const DEFAULT_PERSONAS = [
  { id: 1, name: "Somchai", age: 32, type: "muaythai", emoji: "🥊", color: "#E74C3C", traits: "Thai Muay Thai fighter and gym trainer in Bangkok. Trains 6 hours daily. OBSESSED with muscle recovery and repair - needs fast-absorbing protein. Always compares to cheap local Thai brands. Won't trust foreign brands unless they prove superior results. Requires halal certification. Will buy if it helps recovery after brutal training.", speed: 0.4, size: 42 },
  { id: 2, name: "Anong", age: 27, type: "office", emoji: "👩‍💼", color: "#FF6B35", traits: "Bangkok office worker, wants to lose weight before wedding in 6 months. HEAVILY influenced by Korean and Japanese beauty trends. Believes Japanese products = high quality. TERRIFIED of getting too muscular from protein. Needs low-calorie, beauty-focused messaging. Will buy if it promises slim, toned body without bulk. Japanese brand = acceptable price.", speed: 0.3, size: 38 },
  { id: 3, name: "Niran", age: 45, type: "businessman", emoji: "💼", color: "#3498DB", traits: "Bangkok businessman, doctor scolded him for lack of exercise. ZERO fitness knowledge. Intimidated by gym culture. Needs foolproof Thai instructions. Trusts pharmaceutical companies like Taisho over sports brands. Hates medicine-like taste. Values trust and convenience over price.", speed: 0.35, size: 44 },
  { id: 4, name: "Ploy", age: 25, type: "fitness", emoji: "🏋️‍♀️", color: "#E91E63", traits: "Bangkok fitness influencer with 150K followers. Posts daily workout videos. Aesthetics are EVERYTHING - packaging must be Instagram-worthy. Compares to Korean and Japanese premium brands. Will promote products that sponsor her. Needs clean ingredients for cutting phase.", speed: 0.45, size: 36 },
  { id: 5, name: "Arthit", age: 52, type: "senior", emoji: "🚶", color: "#27AE60", traits: "Chiang Mai retired teacher. Muscle loss from aging. Doctor recommended protein. EXTREMELY price-conscious - converts everything to baht. Needs clarity on plant vs whey protein source. Trusts pharmaceutical companies more than supplement brands. Worried about kidney impact. Wants small pack sizes.", speed: 0.2, size: 40 },
  { id: 6, name: "Kritsada", age: 19, type: "student", emoji: "⚡", color: "#F39C12", traits: "Chulalongkorn University soccer player. BROKE student. Shares protein tub with 3 friends. CANNOT afford premium brands - needs cheapest price per serving. Taste is CRITICAL or won't finish it. HEAVILY influenced by teammates' opinions. Will buy if friends approve.", speed: 0.5, size: 34 },
  { id: 7, name: "Mali", age: 30, type: "mama", emoji: "👶", color: "#1ABC9C", traits: "Phuket new mom. Postpartum body recovery. EXTREMELY cautious about ingredients while breastfeeding. Googles every ingredient. Needs halal certification for peace of mind. Japanese pharmaceutical = seems safer. Must be one-hand preparation (holding baby). Wants small packaging.", speed: 0.25, size: 38 },
  { id: 8, name: "Thana", age: 23, type: "muscle", emoji: "🦾", color: "#8E44AD", traits: "Pattaya aspiring bodybuilder. Also drinks imported protein. Scrutinizes ingredient labels obsessively. Compares amino acid profiles of 10+ brands. Japanese brands = assumes lower protein content. Will ONLY buy if BCAA ratio is 2:1:1 and leucine content is high. Needs scientific backing.", speed: 0.42, size: 40 },
];
