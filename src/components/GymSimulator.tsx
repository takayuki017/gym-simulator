...
const DEFAULT_PERSONAS = [
  { id: 1, name: "Hardcore Gym Bro・Takeshi", age: 28, type: "hardcore", emoji: "💪", color: "#E74C3C", traits: "Goes to the gym 5x/week. Obsessed with protein content and ingredients. Prioritizes protein per serving and cost performance.", speed: 0.4, size: 42 },
  { id: 2, name: "Yoga-Loving OL・Mika", age: 32, type: "wellness", emoji: "🧘‍♀️", color: "#9B59B6", traits: "Health and beauty focused. Values taste and drinkability. Cares about Instagram aesthetics. Prefers low-calorie options.", speed: 0.3, size: 38 },
  { id: 3, name: "Diet Beginner・Yuta", age: 35, type: "diet", emoji: "🏃", color: "#3498DB", traits: "Slightly overweight, doctor recommended exercise. Complete protein newbie. Values simplicity and trustworthiness.", speed: 0.35, size: 44 },
  { id: 4, name: "Fitness Influencer・Aya", age: 25, type: "fitness", emoji: "🏋️‍♀️", color: "#E91E63", traits: "Body transformation goals. Posts fitness content on SNS. Cares about package design and brand image.", speed: 0.45, size: 36 },
  { id: 5, name: "Health-Conscious Senior・Hiroshi", age: 62, type: "senior", emoji: "🚶", color: "#27AE60", traits: "Focused on health maintenance. Trusts the Taisho Pharmaceutical brand. Values drinkability and safety. Has knee pain.", speed: 0.2, size: 40 },
  { id: 6, name: "Student Athlete・Sota", age: 17, type: "student", emoji: "⚡", color: "#F39C12", traits: "Soccer club member. Needs affordable pricing within allowance budget. Won't stick with it if it tastes bad. Influenced by friends' opinions.", speed: 0.5, size: 34 },
  { id: 7, name: "New Mom・Satomi", age: 30, type: "mama", emoji: "👶", color: "#1ABC9C", traits: "Postpartum body recovery and nutrition. Concerned about ingredient safety for children. Needs quick and easy preparation.", speed: 0.25, size: 38 },
  { id: 8, name: "Aspiring Bodybuilder・Ken", age: 21, type: "muscle", emoji: "🦾", color: "#8E44AD", traits: "Also drinks imported protein. Carefully checks ingredient labels. Gets excited about BCAA and HMB formulations.", speed: 0.42, size: 40 },
];
