...
const DEFAULT_PERSONAS = [
  { id: 1, name: "Somchai", age: 32, type: "muaythai", emoji: "🥊", color: "#E74C3C", traits: "タイのムエタイ選手、バンコクでジムトレーナー。毎日6時間トレーニング。筋肉回復と修復に超こだわり - 吸収の速いプロテイン必須。タイの安いローカルブランドと比較する癖あり。外国ブランドは結果が証明されない限り信用しない。ハラール認証重視。過酷なトレーニング後の回復に効果あれば買う。", speed: 0.4, size: 42 },
  { id: 2, name: "Anong", age: 27, type: "office", emoji: "👩‍💼", color: "#FF6B35", traits: "バンコクのOL、6ヶ月後の結婚式までに痩せたい。韓国・日本の美容トレンドに影響されまくり。日本製品＝高品質と信じてる。プロテインで筋肉ムキムキになるのが怖い。低カロリー・美容効果の訴求が必須。細く引き締まった体を約束してくれるなら買う。日本ブランドなら価格OK。", speed: 0.3, size: 38 },
  { id: 3, name: "Niran", age: 45, type: "businessman", emoji: "💼", color: "#3498DB", traits: "バンコク在住のビジネスマン。運動不足で医者に怒られた。フィットネス知識ゼロ。ジムは気後れする。タイ語の分かりやすい説明必須。大正製薬みたいな製薬会社なら信頼できる。薬っぽい味は嫌。価格より信頼性と手軽さ重視。", speed: 0.35, size: 44 },
  { id: 4, name: "Ploy", age: 25, type: "fitness", emoji: "🏋️‍♀️", color: "#E91E63", traits: "バンコクのフィットネスインフルエンサー（フォロワー15万人）。毎日ワークアウト動画投稿。見た目が超重要 - パッケージ映え必須。韓国・日本の高級ブランドと比較。スポンサーしてくれる製品なら宣伝する。成分がクリーンで減量期に使えるものが欲しい。", speed: 0.45, size: 36 },
  { id: 5, name: "Arthit", age: 52, type: "senior", emoji: "🚶", color: "#27AE60", traits: "チェンマイ在住の元教師。加齢で筋力低下。医者にプロテイン勧められた。超価格意識 - バーツ換算で高すぎると無理。植物性かホエイか明確に知りたい。製薬会社の方がサプリブランドより信用できる。腎臓への影響が心配。少量パックが欲しい。", speed: 0.2, size: 40 },
  { id: 6, name: "Kritsada", age: 19, type: "student", emoji: "⚡", color: "#F39C12", traits: "チュラロンコーン大学のサッカー部。超貧乏学生。友達3人でプロテイン共有。高級ブランドは絶対無理 - 1食あたり最安値のものしか買えない。味がまずいと続かない。チームメイトの意見に超影響される。友達が良いって言えば買う。", speed: 0.5, size: 34 },
  { id: 7, name: "Mali", age: 30, type: "mama", emoji: "👶", color: "#1ABC9C", traits: "プーケット在住の新米ママ。産後の体型回復したい。授乳中なので成分に超神経質。全成分をググる。ハラール認証があれば安心。日本の製薬会社製なら安全性高そう。片手で作れるやつじゃないと無理（赤ちゃん抱っこしてるから）。小さいパッケージ希望。", speed: 0.25, size: 38 },
  { id: 8, name: "Thana", age: 23, type: "muscle", emoji: "🦾", color: "#8E44AD", traits: "パタヤのボディビル志望。輸入プロテインも飲んでる。成分表を超細かくチェック。アミノ酸プロファイルを10種類以上のブランドと比較。日本ブランドは含有量少ないイメージ。BCAA比率が2:1:1で、ロイシン含有量高くないと買わない。科学的根拠必須。", speed: 0.42, size: 40 },
];
