...
const DEFAULT_PERSONAS = [
  ...
  { id: 2, name: "Somchai (Thailand)", age: 32, type: "muaythai", emoji: "🥊", color: "#FF6B35", traits: "Thai Muay Thai fighter and gym trainer in Bangkok. Trains 6 hours daily. OBSESSED with recovery and muscle repair - needs fast-absorbing protein. Compares everything to local Thai brands (cheaper). Skeptical of foreign brands unless they prove superior results. Needs halal certification. Will buy if it helps recovery after brutal training sessions.", speed: 0.4, size: 40 },
  { id: 3, name: "Sofia (Brazil)", age: 29, type: "wellness", emoji: "🧘‍♀️", color: "#9B59B6", traits: "Brazilian yoga instructor and wellness influencer with 50K followers. EXTREMELY picky about artificial ingredients - refuses anything with sucralose or aspartame. Values organic, plant-based options. Will buy ONLY if package is Instagram-worthy and ingredients are 100% natural. Willing to pay premium for clean label.", speed: 0.3, size: 38 },
  { id: 4, name: "Yuki (Japan)", age: 45, type: "businessman", emoji: "💼", color: "#3498DB", traits: "Japanese salaryman, overworked, stress eating problem. Doctor warned about diabetes risk. ZERO fitness knowledge - intimidated by gym culture. Needs foolproof instructions in Japanese. Will trust pharmaceutical brands (like Taisho) over sports brands. Wants something that doesn't taste like medicine. Price is secondary to convenience and trust.", speed: 0.35, size: 44 },
  { id: 5, name: "Natasha (Russia)", age: 25, type: "fitness", emoji: "🏋️‍♀️", color: "#E91E63", traits: "Russian fitness model and TikTok creator (200K followers). Posts daily workout content. OBSESSED with aesthetics - product must photograph well. Compares protein to European luxury brands. Will promote products that sponsor her. Skeptical of Asian brands unless they have premium positioning. Needs 'clean' formula for her lean bulk phase.", speed: 0.45, size: 36 },
  { id: 6, name: "Rajesh (India)", age: 52, type: "senior", emoji: "🚶", color: "#27AE60", traits: "Indian IT professional, sedentary lifestyle led to muscle loss (sarcopenia). Doctor recommended protein supplementation. VERY price-conscious - converts everything to rupees. Vegetarian, needs absolute clarity on protein source (whey/plant). Trusts pharmaceutical companies more than supplement brands. Concerned about kidney health. Needs small serving sizes.", speed: 0.2, size: 40 },
  { id: 7, name: "Diego (Mexico)", age: 19, type: "student", emoji: "⚡", color: "#F39C12", traits: "Mexican college soccer player on tight budget. Shares protein tub with 3 roommates. CANNOT afford premium brands - buys whatever is cheapest per serving. Taste is CRITICAL (won't finish bad-tasting protein). Influenced by teammates' recommendations. Doesn't read labels carefully. Will buy if friends approve and price is right.", speed: 0.5, size: 34 },
  { id: 8, name: "Anong (Thailand)", age: 27, type: "office", emoji: "👩‍💼", color: "#1ABC9C", traits: "Thai office worker in Bangkok, wants to lose weight before wedding in 6 months. Influenced by K-beauty and J-beauty trends. Prefers products from Japan (seen as high quality). Worried about getting 'too muscular' from protein. Needs low-calorie, beauty-focused messaging. Will buy if it promises slim, toned body without bulk. Price acceptable if Japanese brand.", speed: 0.25, size: 38 },
];
